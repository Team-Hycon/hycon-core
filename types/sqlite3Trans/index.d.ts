...
// ---------------------------------------------------------------------------
// Type definitions for sqlite3 transaction
// Project: https://github.com/Team-Hycon
// Definitions by: Team HYCON 

/// <reference types="node" />

declare module 'sqlite3Trans'
{
    ...
    export class Database extends events.EventEmitter {
        ...
        beginTransaction(callback: (err: Error, tx: Transaction) => void): void;
