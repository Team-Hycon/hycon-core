...
export const TARGET_PACKET_SIZE = 1024 * 1024
...
export const MAX_HEADERS_PER_PACKET = Math.floor(TARGET_PACKET_SIZE / MAX_HEADER_SIZE)
export const MAX_BLOCKS_PER_PACKET = Math.floor(TARGET_PACKET_SIZE / MAX_BLOCK_SIZE)
